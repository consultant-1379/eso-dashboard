# Display story count for all teams in current sprint
...
SCHEDULER.every '10m', :first_in => 0 do
  begin
    ...
    total_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
       and project=\"#{ENV['JIRA_PROJECT']}\" and issuetype=\"Story\" and \"SM Team Name\" in
        (\"Anvil\", \"Autobots\", \"Inferno\", \"Brahma\")&fields=total")['total']
    ...
    closed_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
      and project=\"#{ENV['JIRA_PROJECT']}\" and issuetype=\"Story\" and status=\"Done\" and \"SM Team Name\" in
        (\"Anvil\", \"Autobots\", \"Inferno\", \"Brahma\")&fields=total")['total']
    ...
    in_progress_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
      and project=\"#{ENV['JIRA_PROJECT']}\" and issuetype=\"Story\" and status=\"In Progress\" and \"SM Team Name\" in
        (\"Anvil\", \"Autobots\", \"Inferno\", \"Brahma\")&fields=total")['total']
    ...
    send_event('SprintProgress', title: 'Overall Sprint Progress', min: 0, value: percentage_finished,
