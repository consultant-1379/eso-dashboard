...
SCHEDULER.every '10m', :first_in => 0 do
  begin
    ...
    total_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
       and project=\"#{ENV['JIRA_PROJECT']}\" and \"SM Team Name\" = 'Inferno' and issuetype=\"Story\"&fields=total")['total']
    ...
    closed_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
      and project=\"#{ENV['JIRA_PROJECT']}\" and \"SM Team Name\" = 'Inferno' and issuetype=\"Story\" and status=\"Done\"&fields=total")['total']
    ...
    in_progress_story_count = jira.retrieve_json("sprint in Opensprints() and sprint not in FutureSprints()
      and project=\"#{ENV['JIRA_PROJECT']}\" and \"SM Team Name\" = 'Inferno' and issuetype=\"Story\" and status=\"In Progress\"&fields=total")['total']
    ...
    send_event('InfernoSprintProgress', title: "Team Inferno's Sprint Progress", min: 0, value: percentage_finished,
